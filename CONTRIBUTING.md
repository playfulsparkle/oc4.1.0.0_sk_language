...
Thank you for your interest in contributing to the Playful Sparkle Slovak Language Pack for OpenCart! We value contributions from the community to enhance this project for all users. Whether you're fixing translation errors, adding missing translations, improving documentation, or suggesting enhancements, your efforts are greatly appreciated.
...
- Knowledge of Slovak language and its grammar rules
...
1. Review the [existing issues](https://github.com/playfulsparkle/oc4_1_0_0_sk_language/issues) to avoid duplicates.
2. Provide detailed information, including:
   - OpenCart version
   - Steps to reproduce the issue (if applicable)
   - Screenshots or examples of incorrect/missing translations
   - Suggestions for improvement (if available)

### Suggesting Features

To propose a new feature or enhancement, open an issue and include:
...
- Avoid literal translations if they do not make sense in Slovak.

### Commit Messages

- Write in present tense (e.g., "Fix typo in translation" instead of "Fixed typo in translation").
...
- Validate edge cases, such as different OpenCart configurations or modules using the language pack.
...
- [GitHub Issues](https://github.com/playfulsparkle/oc4_1_0_0_sk_language/issues)
